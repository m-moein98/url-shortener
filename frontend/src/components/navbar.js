...
const Navbar = () =>{
  function toggleMenu() {
    document.getElementById("mobile-menu__open").classNameList.toggle("hidden");
    document.getElementById("mobile-menu__close").classNameList.toggle("hidden");
    document.getElementById("mobile-menu__items").classNameList.toggle("hidden");
  }
  useEffect(() => {
  ...
  <section className="aw-header bg-white border-b border-gray-200 shadow-md lg:h-11v min-h-11v">
    <header className="container mx-auto flex items-center justify-between flex-wrap px-2 py-4 lg:p-6">
      <div id="mobile-menu__toggler" className="block h-20 lg:hidden">
      ...
      <div className="aw-header__logo flex items-center flex-shrink-0 text-purple-700 hover:text-purple-900 mx-2 lg:mr-6 order-1 transition">
        ...
        <span className="font-semibold text-lg tracking-tight">MOEIN98</span>
      </div>
      ...
      <nav id="mobile-menu__items" className="aw-header__nav hidden w-full block flex-grow lg:flex lg:items-center lg:w-auto order-3 lg:order-2">
        <ol className="text-lg lg:flex-grow lg:flex lg:justify-around">
          <li className="block mb-4 mt-3 lg:inline-block lg:mb-0 lg:mt-0 mr-4">
            <a href="#responsive-header" className="text-gray-700 hover:text-gray-900 transition">Welcome</a>
          </li>

          <li className="block mb-4 lg:inline-block lg:mb-0 mr-4">
            <a href="#responsive-header" className="text-gray-700 hover:text-gray-900 transition">Services</a>
          </li>

          <li className="block mb-4 lg:inline-block lg:mb-0 mr-4">
            <a href="#responsive-header" className="text-gray-700 hover:text-gray-900 transition">Sold Projects</a>
          </li>

          <li className="block mb-4 lg:inline-block lg:mb-0 mr-4">
            <a href="#responsive-header" className="text-gray-700 hover:text-gray-900 transition">Products & Shop</a>
          </li>
